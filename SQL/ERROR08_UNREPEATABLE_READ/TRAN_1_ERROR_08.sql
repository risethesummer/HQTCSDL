...
SELECT dh.PHI_SP AS N'Thuộc tính giá'
FROM DON_HANG dh
WHERE dh.MA_DH = 'DH000000';

SELECT SUM(dhsp.SO_LUONG_SP_DH * GIA_SP_DH) AS N'Tổng giả trong chi tiết hóa đơn'
FROM DON_HANG_SP dhsp
WHERE dhsp.MA_DH = 'DH000000';
